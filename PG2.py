...
img =Image.open(r"C:\pictures\online-shopping-mobile-phone-min-2.jpg")
...
def home():
    ...
    fra.pack()
    name = Label(fra, text="---LITTLE ONLINE SHOPPING---", bg="black", font=("Brush Script MT", 30, 'bold'),
...
def mobile():
    ...
    name = Label(ff, text="---LITTLE ONLINE SHOPPING---", bg="black", font=("Brush Script MT", 30, 'bold'), fg="white",
                 width=200)
    name.pack()
...
def tv():
    ff = Frame(fra,bg='gray')
    ff.pack(fill=X)
    name=Label(ff,text="---LITTLE ONLINE SHOPPING---",bg="black",font=("Brush Script MT",30,'bold')
       ,fg="white",width=200)
    name.pack()
#frame
    f1 = Frame(ff, bg="white", width=1000, height=600)  
...
##        
    ...
    title=Label(f1,text="ミ★Little online shoping★彡",font=("Times New Roman",40,"bold"),bg="#000033",fg="red")
    ...
    label_1=Label(f1,text="FIRST_NAME",font=("Calibri",20),bg="white",fg="red")
    label_1.place(x=50,y=200)
    ebb_1=Entry(f1)
    ebb_1.place(x=250,y=200,width=220,height=23)
...
#page2
title=Label(top,text="ミ★Little online shoping★彡",font=("Times New Roman",40,"bold"),bg="#000033",fg="red")
title.place(x=250,y=20)
