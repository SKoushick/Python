...
label_0=Label(top,text="REGISTRATION DETAILS",font=("Calibri",25),bg="white",fg="red")
label_0.place(x=515,y=150)
        
label_1=Label(top,text="FIRST NAME",font=("Calibri",20),bg="white",fg="red").place(x=230,y=220)
ebb_1=Entry(top)
ebb_1.place(x=440,y=229,width=220,height=23)
        
label_2=Label(top,text="LAST NAME",font=("Calibri",20),bg="white",fg="red")
label_2.place(x=690,y=220)
ebb_2=Entry(top)
ebb_2.place(x=940,y=229,width=220,height=23)
        
label_3 = Label(top, text="GENDER", font=("Calibri", 20), bg="white",fg="red")
label_3.grid(column=0, row=3, padx=229, pady=260)

data = tk.StringVar()
ebb = ttk.Combobox(top, textvariable=data)
ebb["values"] = ("MALE", "FEMALE", "TRANSGENDER")
ebb.current(0)  
ebb.grid(column=1, row=2, padx=1, pady=10)

ebb.current()
ebb["values"]=("MALE","FEMALE","TRANSGENDER")
ebb.grid(column=1,row=3)
label_4=Label(top,text="DATE OF BIRTH",font=("Calibri",20),bg="white",fg="red")
label_4.place(x=690,y=260)
ebb_4=Entry(top)
ebb_4.place(x=940,y=269,width=220,height=23)
        
label_5=Label(top,text="ACC NO",font=("Calibri",20),bg="white",fg="red")
label_5.place(x=230,y=300)
ebb_5=Entry(top)
ebb_5.place(x=440,y=309,width=220,height=23)
        
label_6=Label(top,text="ACC TYPE",font=("Calibri",20),bg="white",fg="red")
...
label_7=Label(top,text="MOBILE NO",font=("Calibri",20),bg="white",fg="red")
label_7.place(x=230,y=340)
ebb_7=Entry(top)
ebb_7.place(x=440,y=349,width=220,height=23)
            
label_8=Label(top,text="E-MAIL ID",font=("Calibri",20),bg="white",fg="red")
label_8.place(x=690,y=340)
ebb_8=Entry(top)
ebb_8.place(x=940,y=349,width=220,height=23)
            
label_9=Label(top,text="INITIAL AMOUNT",font=("Calibri",20),bg="white",fg="red")
label_9.place(x=230,y=380)
ebb_9=Entry(top)
ebb_9.place(x=440,y=389,width=220,height=23)
            
label_10=Label(top,text="USER NAME",font=("Calibri",20),bg="white",fg="red")
label_10.place(x=230,y=440)
ebb_10=Entry(top)
ebb_10.place(x=440,y=449,width=220,height=23)
            
label_11=Label(top,text="PASSWORD",font=("Calibri",20),bg="white",fg="red")
label_11.place(x=230,y=480)
ebb_11=Entry(top)
ebb_11.place(x=440,y=489,width=220,height=23)
            
label_12=Label(top,text="CONFIRM PASSWORD",font=("Calibri",20),bg="white",fg="red")
...
back=Button(top,text="Back",
            activebackground="red",cursor="clock",
            font=("times new roman",10,"bold"),bg="green",fg="yellow").place(x=1000,y=550)
top.mainloop()
