...
def home():
    main = Frame(a, bg="#D3D3D3", height=1000)
    main.pack(fill=X)
...
###title
def tv():
    name=Label(fra,text="---ONLINE SHOP NAME---",bg="black",font=("Brush Script MT",30,'bold')
       ,fg="white",width=200)
    name.pack()
#frame
...
#home buttom
    ...
    butnh=Button(ff,text='Back To Home',width=40,height=2,activebackground='#2E86C1',
                 fg='white',bg='#5DADE2',cursor='mouse',font=("Arial", 15, "bold")
                 ,command=f1.destroy)
    butnh.place(x=0,y=529)
    butnc=Button(f1,text='Viwe Your Cart',width=40,height=2,activebackground='#D35400',
