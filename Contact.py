...
root = Tk()
root.title("Application For Contact Book")
root.geometry('700x550')
root.resizable(0, 0)

# Creating the color and font variables
lf_bg = 'lightblue'  # Lightest Shade
cf_bg = 'red'
rf_bg = 'lightblue'  # Darkest Shade
...
Label(root, text='CONTACT BOOK', font=("Noto Sans CJK TC", 15, "bold"), bg='red', fg='White').pack(side=TOP, fill=X)
