...
##connection=mysql.connector.connect(host='localhost',user='root',password='Kousi7023',database='new')
...
img =Image.open('C:/Users/Admin/Pictures/online-shopping-mobile-phone-min-2.jpg')
...
def regis():
    ...
    label_0=Label(f1,text="REGISTRATION DETAILS",font=("Calibri",25),bg="white",fg="red")
    label_0.place(x=430,y=150)
                        
    label_1=Label(f1,text="FIRST_NAME",font=("Calibri",20),bg="white",fg="red").place(x=50,y=220)
    ebb_1=Entry(f1)
    ebb_1.place(x=250,y=229,width=220,height=23)
...
##        elif (ebb_1.get()and ebb_2.get() and ebb_3.get() and ebb_4.get() and ebb_7.get() and ebb_8.get() and ebb_10.get() and ebb_11.get() and ebb_12.get() and ebb_11.get() == ebb_12.get()):
##            op = messagebox.askyesno("Save", "Do you really want to save?")
##            if op > 0:
##                cursor=connection.cursor()
##
##                sql_statement="INSERT INTO registration(FIRST_NAME,LAST_NAME,GENDER,DATE_OF_BIRTH,MOBILE NO,E-MAIL_ID,USERNAME,PASSWORD,CONFIRM_PASSWORD) values(%s,%s,%s,%s,%s,%s,%s,%s,%s)"
##                values=(ebb_1.get(),ebb_2.get(),ebb_3.get(),ebb_4.get(),ebb_7.get(),ebb_8.get(),ebb_10.get(),ebb_11.get(),ebb_12.get())
